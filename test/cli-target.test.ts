...
describe("materialization target CLI syntax", () => {
  it("parses explicit modes and retains Windows drive separators", () => {
    expect(parseMaterializationTargetSpec("codex=symlink=/home/test/.codex/skills")).toEqual({
      slug: "codex",
      mode: "symlink",
      root: "/home/test/.codex/skills",
    });
    expect(parseMaterializationTargetSpec("codex=junction=C:\\Users\\test\\.codex\\skills")).toEqual({
      slug: "codex",
      mode: "junction",
      root: "C:\\Users\\test\\.codex\\skills",
    });
