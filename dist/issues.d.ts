export type DotagentIssueCode = "invalid-json" | "invalid-manifest" | "invalid-lockfile" | "unsupported-schema" | "unsafe-path" | "duplicate-skill" | "integrity-mismatch" | "unsafe-link" | "limit-exceeded" | "missing-skill-file" | "file-not-found" | "io-error";
